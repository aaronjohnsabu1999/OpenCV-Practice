...
image01 = cv2.imread('/home/aaronjs/Documents/Pictures/Aaron John Sabu.jpg', cv2.IMREAD_COLOR)
...
image01 = cv2.circle(image01,(width/2-3,height/2-20),70,(0,255,0),2)
...
if keyb_inp == 27:
	...
	cv2.imwrite('./Aaron_Geometrified.png', image01)
	cv2.destroyAllWindows()
else:
	print('NA')
